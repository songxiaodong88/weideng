 ...
 */
@Data
public class PRESchoolExcelEntity extends BaseRowModel {
    ...
    //  缴费方式
    @ExcelProperty(value = "缴费方式",index = 2)
    private String paymentMethod;
    //  截止日期
    @ExcelProperty(value = "截止日期",index = 3)
    private String periodOfValidity;
    //  缴费日期
    @ExcelProperty(value = "缴费日期",index = 4)
...
//    private Double july;*/
    //  课外班
    @ExcelProperty(value = "课外班",index = 6)
    private String interestClasses;
    //  备注
    @ExcelProperty(value = "备注",index = 7)
    private String remark;
    //  学平险
    @ExcelProperty(value = "学平险",index = 8)
    private String studentsSafetyInsurance;
    //  档案
    @ExcelProperty(value = "档案",index = 9)
    private String record;
    //  协议
    @ExcelProperty(value = "协议",index = 10)
    private String protocol;
    //  备忘
    @ExcelProperty(value = "备忘",index = 11)
    private String memo;
}
