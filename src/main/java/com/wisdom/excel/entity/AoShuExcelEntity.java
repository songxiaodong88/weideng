 ...
 */
@Data
public class AoShuExcelEntity extends BaseRowModel {
...
//    @ExcelProperty(value = "收入比例50%", index = 6)
    ...
    //  9月消课
    @ExcelProperty(value = "9月消课", index = 6)
    private String jiuYue;
    //  10月消课
    @ExcelProperty(value = "10月消课", index = 7)
    private String shiYue;
    //  11月消课
    @ExcelProperty(value = "11月消课", index = 8)
    private String shiYiYue;
    //  12月消课
    @ExcelProperty(value = "12月消课", index = 9)
    private String shiErYue;
    //  书费单价
//    @ExcelProperty(value = "书费单价", index = 10)
