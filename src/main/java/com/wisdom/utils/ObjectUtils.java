    ...
    public static void annotationToObject(Object annotation, Object object) {
        if (annotation != null) {
            ...
            for (Method m : objectClass.getMethods()) {
                if (org.apache.commons.lang.StringUtils.startsWith(m.getName(), "set")) {
                    try {
                        String s = org.apache.commons.lang.StringUtils.uncapitalize(StringUtils.substring(m.getName(), 3));
